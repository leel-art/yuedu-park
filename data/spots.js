// data/spots.js —— 岳渎公园景点数据
// 每个景点对应一个唯一的 scene ID，用于生成二维码
// 微信扫码 → 小程序 onLaunch 获取 scene → 自动跳转到该景点的视频讲解
...
const spots = [
  ...
  },
  {
    ...
    detail: [
      ...
      { title: '🎧 语音导览', content: '您现在站在落日崖的最前端。脚下是深约80米的峡谷，前方是黄河河谷。距离日落还有（根据时间动态播报）分钟。请站稳扶好栏杆，享受这壮美的黄河落日。如果运气好，您还能看到成群的候鸟在夕阳中飞过河面。' }
    ],
